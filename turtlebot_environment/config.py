...
#config['total_env_steps'] = int(40e5)
#config['batch_size'] = 256
#config['warmup_samples'] = 5000
#config['eval_freq'] = 5000
#config['epi_len'] = 3000
#config['n_iter_eval'] = 5
#config['epi_len_eval'] = 3000
#config['act_fn'] = nn.LeakyReLU
#config['tau'] = 0.995
#config['log'] = True
#config['log_name'] = "log_turtlebot_avoid"
#config['log_best_name'] = "log_best_turtlebot_avoid"
...
#
#config['seed'] = 5
#config['buffer_size'] = int(20e5)
#config['total_env_steps'] = int(100e5)
#config['batch_size'] = 512
#config['warmup_samples'] = 20000
#config['eval_freq'] = 5000
#config['epi_len'] = 13000
#config['n_iter_eval'] = 5
#config['epi_len_eval'] = 13000
#config['act_fn'] = nn.LeakyReLU
#config['tau'] = 0.995
#config['log'] = True
#config['log_name'] = "log_turtlebot_2_goal_3_obs"
#config['log_best_name'] = "log_best_turtlebot_2_goal_3_obs"
#config['update_freq'] = 1
#config['q_freq'] = 1
#config['gamma'] = 0.99
#config['init_epsilon'] = 1
#config['final_epsilon'] = 0.1
#config['anneal_limit'] = int(45e5)
#config['target_update'] = 20000
#
#
#config['lr_q'] = 1e-4
#config['hidden_layer'] = [256,256,256,150]
...
config['lr_q'] = 1e-4
config['hidden_layer'] = [64,64,64]   #3 -> 256,128,128 ,  4 -> 64,128,128, 5 -> 256,512,256  6->512,512,512
                                                #7 -> 64,64,64,64,64,64
...
#config['seed'] = 5
#config['buffer_size'] = int(10e5)
#config['total_env_steps'] = int(20e5)
#config['batch_size'] = 256
#config['warmup_samples'] = 5000
#config['eval_freq'] = 5000
#config['epi_len'] = 800
#config['n_iter_eval'] = 5
#config['epi_len_eval'] = 800
#config['act_fn'] = nn.ReLU
#config['tau'] = 0.995
#config['log'] = True
#config['log_name'] = "log_turtlebot_2_goals_1discretize_0.1"
#config['log_best_name'] = "log_best_turtlebot_2_goals_1discretize_0.1"
#config['update_freq'] = 1
#config['q_freq'] = 1
#config['gamma'] = 0.99
#config['init_epsilon'] = 1
